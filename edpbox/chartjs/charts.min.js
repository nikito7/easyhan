...
var fileName='LP-'+mo.format('YYYY-MM')+'.csv'
var nextF='LP-'+mo.add(1,'M').format('YYYY-MM')+'.csv'
var nextM=mo.format('MM[&a=]YYYY');var prevF='LP-'+mo.subtract(2,'M').format('YYYY-MM')+'.csv'
...
$.get(fileName,{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart1',data,'Energia - 30 Dias (kWh/15min)')})
$("#chart2").hide()
$("#chart3").hide()
break;default:$("#navMes").hide()
$.get('0d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart1',data,'Energia - Hoje (kWh)')})
$.get('1d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart2',data,'Energia - Ontem (kWh)')})
$.get('2d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart3',data,'Energia - Anteontem (kWh)')})}});
