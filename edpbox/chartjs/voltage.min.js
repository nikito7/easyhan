...
$.get('vt-0d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart1',data,'Tensão - Hoje')})
$.get('vt-1d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart2',data,'Tensão - Ontem')})
$.get('vt-2d.csv',{'_':$.now()},function(csvString){var data=Papa.parse(csvString).data;makeChart('chart3',data,'Tensão - Anteontem')})}});
